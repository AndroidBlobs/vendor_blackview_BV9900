...
CUSTOM_HAL_IMGSENSOR = imx582_mipi_raw imx582cts_mipi_raw gc5035_mipi_raw gc5035cts_mipi_raw s5k3p9sx_mipi_raw s5k3p9sxcts_mipi_raw s5k3p9sxsub_mipi_raw s5k3p9sxsubcts_mipi_raw gc2375h_mipi_raw gc2375hcts_mipi_raw
CUSTOM_HAL_LENS = dw9714af dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR = gc5035_mipi_raw
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS = 
CUSTOM_HAL_MAIN_IMGSENSOR = imx582_mipi_raw imx582cts_mipi_raw
CUSTOM_HAL_MAIN_LENS = 
CUSTOM_HAL_MAIN3_IMGSENSOR = gc2375h_mipi_raw
CUSTOM_HAL_MSENSORLIB = akl akm
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR =
CUSTOM_HAL_SUB_BACKUP_LENS = dw9714af
CUSTOM_HAL_SUB_IMGSENSOR = s5k3p9sxsub_mipi_raw s5k3p9sxsubcts_mipi_raw
CUSTOM_HAL_SUB2_IMGSENSOR = s5k3p9sx_mipi_raw s5k3p9sxcts_mipi_raw 
...
CUSTOM_KERNEL_IMGSENSOR = imx582_mipi_raw imx582cts_mipi_raw gc5035_mipi_raw gc5035cts_mipi_raw s5k3p9sx_mipi_raw s5k3p9sxcts_mipi_raw s5k3p9sxsub_mipi_raw s5k3p9sxsubcts_mipi_raw gc2375h_mipi_raw gc2375hcts_mipi_raw
...
CUSTOM_KERNEL_MAIN_IMGSENSOR = imx582_mipi_raw imx582cts_mipi_raw
CUSTOM_KERNEL_MAIN_LENS = 
CUSTOM_KERNEL_MAIN3_IMGSENSOR = gc2375h_mipi_raw
...
CUSTOM_KERNEL_SUB_IMGSENSOR = s5k3p9sxsub_mipi_raw s5k3p9sxsubcts_mipi_raw
CUSTOM_KERNEL_SUB2_IMGSENSOR = s5k3p9sx_mipi_raw s5k3p9sxcts_mipi_raw 
...
CUSTOM_MODEM=s990_tk_md-lwctg_6779-6m_gsm4p_w1_2_4_5_6_8_19_fdd1_2_3_4_5_7_8_12_13_17_18_19_20_25_26_28a_28b_66_tdd34_38_39_40_41_tds34_39_c2kbc0_bc1_bc10_cotsx_airohapa_tiaoxie
CUSTOM_SEC_AUTH_SUPPORT = no
CUSTOM_SEC_SIGNTOOL_SUPPORT = no
CUSTOM_KERNEL_HUMIDITY = yes
CUSTOM_KERNEL_TEMPURATURE = no
CUSTOM_KERNEL_AMBIENT_TEMPERATURE = yes
DCORE_TEST_MODE1 = no
DISABLE_EARPIECE = no
...
MTK_RELEASE_PACKAGE = rel_customer_basic rel_customer_kernel_4-9 rel_customer_platform_mt6779 rel_customer_modem rel_customer_product_sp
...
################################################hct mmi modfity#########################################
CUSTOM_BUILD_VERNO = R13_20191225
MTK_BUILD_VERNO = BV9900_EEA_S900AA_V1.0_20191225V08
HCT_BUILD_PRODUCT_NAME = s900aa-dk-dk015-a2-combom-66-256G8G-fhdp-bom2-p0-cts-eu
HCT_LOCALIZATION_OVERLAY = zh-rCN
HCT_PRODUCT_TIMEZONE = Europe/London
HCT_PRODUCT_BRAND = Blackview
HCT_PRODUCT_MODEL = BV9900
HCT_PRODUCT_NAME = BV9900_EEA
HCT_PRODUCT_MANUFACTURER = Blackview
HCT_VERSION_INCREMENTAL=1575339962
HCT_BOOTANIM=yes
HCT_SHUTANIM=yes
# HCT_BOOTAUDIO
...
HCT_RINGTONE=blackview.ogg
HCT_ALARM_ALERT=Chanting.ogg
HCT_NOTIFICATION_SOUND=Default.ogg
#fota
ADUPS_FOTA_SUPPORT=yes
ADUPS_FOTA_WITH_ICON=no
ADUPS_FOTA_WITHOUT_MENU=no
#fingerprint_tee
HCT_SUPPORT_FINGERPRINT_CHIP = goodix_dk_3216_tee
# HCT_SUPPORT_FINGERPRINT
...
#修复联系人SIM卡序号
HCT_FIXED_SIM_ID = yes
#智能唤醒
#HCT_SUPPORT_GESTUREWAKE
#儿童模式
...
#FreeMe Launcher
#HCT_FREEMELITE_SUPPORT
#单层桌面
HCT_SINGLE_PAGE_LAUNCHER3_MI = yes
#单层壁纸
HCT_SINGELSCREEN_WALLPAPER = yes
# 系统管家
# HCT_SUPPORT_SYSTEM_MANAGER
# 自启动管理
...
#多科定制后台清理 8GB项目关闭
# HCT_BG_CLEAN_MEMORY_DUOKE
# HCT可隐藏风格导航栏
HCT_NAVIGATION_BAR_STYLE = yes
# OPPO风格手势导航栏
HCT_OPPO_NAVBAR_STYLE=yes
# 智能体感
HCT_MULTI_FINGER_GESTURE_SUPPORT = yes
#性能模式
HCT_SPROT_MODE = yes
#视频播放器
#HCT_SUPPORT_VIDEOPLAYER
#夜视仪
#HCT_UVC_CAMERA
#镜子
#HCT_MIRROR_SUPPORT
#联网控制
HCT_NETWORK_CONTROL=yes
#心率
#HCT_HEART_RATE_SUPPORT
HCT_SUPPORT_HctHealthCare=yes
# 下拉主题
HCT_SYSTEMUI_FREEME_THEME_LIGHT=yes
# 状态栏新样式
HCT_STATUSBAR_STYLE_SUPPORT=yes
# 人脸解锁
FACE_UNLOCK_SUPPORT = true
#空气检测传感器
HCT_SUPPORT_AIR_SENSOR = yes
# 傅里叶音频校准项目
HCT_SMARTPA_CALIBRATION = yes
# 气压计 温湿度
...
#信号格标准
HCT_DK_SIGNAL_STRENGTH=yes
#水下相机
HCT_UNDER_WATER_SUPPORT=yes
#游戏模式
HCT_GAMEMODE_SUPPORT=yes
#预置语音信箱号码
HCT_PRESET_VOICEMAIL_NUMBER = yes
#多科本地商城
HCT_BLACKVIEW_SUPPORT=yes
#默认chrome主页设置
HCT_CHROME_HOMEPAGE_CUSTOMIZE=yes
#移除分享界面sms图标
HCT_RM_SMS_SHARE=yes
#下拉菜单背景客制化
# HCT_SYSTEMUI_THEME_LIGHT
HCT_SYSTEMUI_SIMPLE_THEME_LIGHT = yes
#内存显示
HCT_NOT_INIT_NVRAM = yes
#录音机音质选项
HCT_SOUNDRECORDER_VOICE_QUALITY_SUPPORT = yes
#多科来电风格
HCT_SUPPORT_DUOKE_INCALLUI = yes
HCT_WIFI_EVALUATOR=yes
HCT_THREE_IS_SIMPLESHOT=yes
#卓易翻译apk
FREEME_TRANSLATOR_SUPPORT=yes
#低温模式开关
HCT_ICEMODE_SUPPORT=yes
#紫外
HCT_SUPPORT_HctUV=yes
#说明书
HCT_USERGUIDE_SUPPORT=yes
#计步器
HCT_STEP_RECORD_SUPPORT=yes
#日期格式
HCT_SUPPORT_DATEFORMAT_CHANGE=yes
#手电筒
HCT_TORCH_SUPPORT=yes
#谷歌商店清理数据
HCT_INSTAGRAM_ISSUE_WORKAROUND=yes
#设置里添加内存菜单
HCT_MEMORY_IN_SETTING_HOMEPAGE=yes
#CTS
MTK_FW_UPGRADE=no
MTK_2SDCARD_SWAP=no
...
HCT_EEA_TPYE4C = yes
#mada
HCT_GOOGLE_CLIENTIDBASE = android-hct
#AWCamera Overlay 360相机水下相机开关
AWCAMERA_OVERLAY_SUPPORT = yes
# 无线升级翻译
ADUPS_FOTA_SUPPORT_OVERLAY=yes
HCT_GOOGLE_GMS_R11=yes
HCT_PACKAGES_SUBSTITUTE = Baidu_Location:- DeskClockGoogle:- GoogleContacts:- GoogleDialer:- TagGoogle:- Keep:- CalculatorGoogle:- OobConfig:- GmsSampleIntegration:- FaceLock:- MtkCalendar:- MtkBrowser:- MtkLatinIME:- MtkMms:- MtkGallery2:- GmsSampleIntegration:- GmsEEAType4cIntegration:-

#[Begin][aw_bokeh]  Modify this setting  [20190727]
AIWORKS_SCENE_SUPPORT=yes
#[End][aw_bokeh]  Modify this setting  [20190727]

#[Begin][aw_bokeh]  Modify this setting  [20190605]
AIWORKS_STEREO_SUPPORT=yes
AIWORKS_DUAL_CAM_ID_IS_5=yes
#[End][aw_bokeh]  Modify this setting  [20190605]

#[Begin][AW_CAMERA_APP_VERSION]  Modify this setting  [20191113]
AW_CAMERA_APP_VERSION=BV9900
#[End][AW_CAMERA_APP_VERSION]  Modify this setting  [20191113]
MTK_ATF_SUPPORT=yes
MTK_TEE_SUPPORT=yes
